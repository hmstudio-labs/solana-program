...
func TestPumpfunBuyData(t *testing.T) {
	...
	buy := NewBuyInstruction(
		amount, maxSolCost, unknow, unknow, unknow, unknow, unknow, unknow, unknow, unknow, unknow,
	)
	i := buy.Build()
	data, err := i.Data()
...
func TestPumpfunSellData(t *testing.T) {
	...
	buy := NewSellInstruction(
		amount, minSolOutput, unknow, unknow, unknow, unknow, unknow, unknow, unknow, unknow, unknow,
	)
	i := buy.Build()
	data, err := i.Data()
